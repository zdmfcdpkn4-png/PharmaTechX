    ...
    <article>
      ...
      <section className="carte">
        ...
        <ul>
          ...
          <li><strong>Sur rattachement seulement</strong> : si vous rattachez votre progression à votre identifiant avec votre code personnel, vos évaluations (résultat complet), la fin de vos entraînements (score), les modules lus et l&apos;évaluation en cours sont conservés sous cet identifiant, pour les retrouver d&apos;une session à l&apos;autre et en parler avec votre tuteur. Le code personnel est conservé haché, jamais en clair ; votre tuteur peut le réinitialiser, jamais le lire.</li>
