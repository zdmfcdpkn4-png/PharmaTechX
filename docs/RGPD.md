...
| Finalités | 1. Documenter l'évaluation des connaissances (étape 2 sur 6) préalable à l'habilitation du personnel de l'unité. 2. En tenir la traçabilité : registre des rapports, répertoire par agent et par critère. 3. Tracer les actes de décision (arbitrage, visas) et d'administration (journal). 4. Suivre le parcours de formation de l'agent qui rattache sa progression (décision du 18/09/2026, question 11, choix c) ; ses évaluations conservées servent aussi à lui poser d'autres questions réservées que celles déjà vues corrigées (question 71, choix b). Le rapport ne vaut pas habilitation. |
