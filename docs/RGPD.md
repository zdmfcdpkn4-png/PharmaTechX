...
| Ressources tierces | Aucune : le navigateur ne joint que le site, polices comprises (décision du 23/09/2026, `docs/DECISIONS.md`). Jusqu'à cette version, chaque page chargeait la police Inter depuis Google Fonts, qui recevait l'adresse IP du poste — sur le site en ligne jusqu'à la mise à jour de la branche `production` `[à compléter : date]` |
